  ...
  return (
    <div className="hidden shrink-0 items-center lg:flex">
      <Link
        ...
        className="group inline-flex h-10 items-center gap-2 rounded-full bg-primary-500 pl-4 pr-2 text-sm font-semibold text-white transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-primary-600 active:scale-[0.98]"
      >
        Cotizar
